           ...
           .=-   .===-    :=:   .-==:.   .==.    .=-             
            ...
            .           .:-=-:=- .-==:.                          
                            .-====:.                             
                               ==                                
                               :=.                                                                                                                                                                                                                             
[""" + spe.r + "#" + spe.g + """] 0day Priv8 Bot 200+ Vuln\n
[""" + spe.r + "#" + spe.g + """] create : BY NIT & Nittool1
[""" + spe.r + "!" + spe.g + """] Telegram :@nityugo1 """) 
...
print("\n\n"+spe.r+"[1]"+spe.g+" From list(NIT)\n"+spe.r+"[2]"+spe.g+" IP Reverse and Scan(NIT)\n")
...
tool = input("[" + spe.r + "?" + spe.g + "] Click Number : ")
